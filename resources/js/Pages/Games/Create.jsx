...
export default function Create({ auth }) {
    ...
    const submit = (e) => {
        e.preventDefault();
        post(route('games.store')); // Enviamos los datos al método store del controlador
    };

    return (
        <AuthenticatedLayout
            user={auth.user}
            header={<h2 className="font-semibold text-xl text-gray-800 leading-tight">Crear Nuevo Juego</h2>}
        >
                    ...
                    <div className="bg-white overflow-hidden shadow-sm sm:rounded-lg p-6">
                        ...
                        <form onSubmit={submit} className="space-y-6">
                            ...
                            <div className="flex items-center">
                                ...
                                />
                                <span className="ml-2 text-sm text-gray-600">Publicar juego inmediatamente</span>
                            </div>
